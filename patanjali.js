...
{ "pS": "dvitiyaH| sAdhanapAdaH",    "pE": "Chapter 2: On Sadhana",         "cnt": 55 },
...
"dRRiShTaanushravikaviShayavitRRiShNasya vashiikaarasa~nj~naa vairaagyam||15||",
...
"tatra niratishayaM sarvaj~naviijam||25||",
...
"tasyaapi nirodhe sarvanirodhaannirviijaH samaadhiH||51||",
],[
...
"vaahyaabhyantarastambhavRRittiH deshakaalasa~NkhyaabhiH paridRRiShTo diirghasuukShmaH||50||",
"vaahyaabhyantaraviShayaakShepii chaturthaH||51||",
...
"tadapi vahira~NgaM nirviijasya||8||",
...
"sopakramaM nirupakramaM cha karma tatsaMyamaadaparaantaj~naanamariShTebhyo vaa||22||",
"maitryaadiShu balaani||23||",
"baleShu hastibalaadiini||24||",
"pravRRittyaalokanyaasaatsuukShmavyavahitaviprakRRiShTaj~naanam ||25||",
"bhuvanaj~naanaM suurye saMyamaat||26||",
"chandre taaraavyuuhaj~naanam||27||",
"dhruve tadgatij~naanam||28||",
"naabhichakre kaayavyuuhaj~naanam||29||",
"kaNThakuupe kShutpipaasaanivRRittiH||30||",
"kuurmanaaDyaaM sthairyam||31||",
"muurdhajyotiShi siddhadarshanam||32||",
"praatibhaadvaa sarvam||33||",
"hRRidaye chittasaMvit||34||",
"sattvapuruShayoratyantaasa~NkiirNayoH pratyayaavisheSho bhogaH paraarthatvaatsvaarthasaMyamaatpuruShaj~naanam||35||",
"tataH praatibhashraavaNavedanaadarshaasvaadavaartaa jaayante||36||",
"te samaadhaavupasargaa vyutthaane siddhayaH||37||",
"bandhakaaraNashaithilyaatprachaarasaMvedanaachcha chittasya parashariiraaveshaH||38||",
"udaanajayaajjalapa~NkakaNTakaadiShvasa~Nga utkraantishcha||39||",
"samaanajayaajjvalanam||40||",
"shrotraakaashayoH sambandhasaMyamaaddivyaM shrotram||41||",
"kaayaakaashayoH sambandhasaMyamaallaghutuulasamaapatteshchaakaashagamanam||42||",
"vahirakalpitaa vRRittirmahaavidehaa tataH prakaashaavaraNakShayaH||43||",
"sthuulasvaruupasuukShmaanvayaarthavattvasaMyamaadbhuutajayaH||44||",
"tato'NimaadipraadurbhaavaH kaayasampattaddharmaanabhighaatashcha||45||",
"ruupalaavaNyabalavajrasaMhananatvaani kaayasampat||46||",
"grahaNasvaruupaasmitaanvayaarthavattvasaMyamaadindriyajayaH||47||",
"tato manojavitvaM vikaraNabhaavaH pradhaanajayashcha||48||",
"sattvapuruShaanyataakhyaatimaatrasya sarvabhaavaadhiShThaatRRitvaM sarvaj~naatRRitvaM cha||49||",
"tadvairaagyaadapi doShaviijakShaye kaivalyam||50||",
"sthaanyupanimantraNe sa~NgasmayaakaraNaM punaraniShTaprasa~Ngaat||51||",
"kShaNatatkramayoH saMyamaadvivekajaM j~naanam||52||",
"jaatilakShaNadeshairanyataanavachChedaattulyayostataH pratipattiH||53||",
"taarakaM sarvaviShayaM sarvathaaviShayamakramaM cheti vivekajaM j~naanam||54||",
"sattvapuruShayoH shuddhisaamye kaivalyamiti||55||",
],[
...
"tatastadvipaakaanuguNaanaamavaabhivyaktirvaasanaanaam||8||",
...
"By the firmly convinced practice of the complete cessation of the mental modiications, the impressions only remain. This is the other samadhi [asamprajnata nor non-distinguished].",
...
"The intellect and the Purusha (or Atman) are totally different, the intellect existing for the sake of the Purusha, while the Purusha exists for its own sake. Not distinguishing this is the cause of all experiences; and by samyama on the distinction, knowledge of the Purusha is gained.",
...
"Incidental events do no directly cause natural evolution; they just remove the obstacles as a farmer [removes the obstacles in a water course running to his field].",
...
"Due to His changelessness, changes in the mind-stuff are always known to the Purusha, who is its Lord.",
...
"Though having countless desires, the mind-stuff exists for the sake of another [the Purusha] because it an act only in association with it.",
...
"They can be removed, as in the case of the obstacles explained before. [See Book 2, Sutras 1, 2, 10, 11 and 26.]",
...
"Thus, the supremestate of Independence manifests while the gunas reabsorb themselves into Prakriti, having no more purpose to serve the Purusha, Or, to look from another angle, the power of pure consciousness settles in its own pure nature.",
]];
...
"In this state, one may experience bodilessness, or become merged in nature. They may lead to isolation or to a state of loneliness.",
...
"From proficiency in nirvicara samapatti comes purity. Sattva or luminosity flows undisturbed, kindling the spiritual light of the self.",
...
"Study of the silent moments between rising and restraining subliminal impressions is the transformation of consciousness towards restraint (nirodhaparinamah).",
...
"Through these three phases, cultured consciousness is transformed from its potential state (dharma) towards further refinement (laksana) and the zenith of refinement (avastha). In this way, the transformation of elements, senses an mind takes place.",
...
"By samyama on strength, the yogi will develop the physical strength, grace, and endurance of an elephant.",
"Concealed things, near or far, are revealed to a yogi.",
"By samyama on the sun the yogi will have knowledge of the seven worlds, and of the seven cosmic centres in the body.",
...
"By performing samyama on the light of the crown of the head (ajna cakra), the yogi has visions of perfected beings.",
...
"By mastery of udan vayu, the yogi can walk over water, swamps and thorns without touching them. He can also levitate.",
"By samyama on samana vayu, a yogi glows like fire and his aura shines.",
"By samyama on the relation between space and sound, the yogi acquires the power of hearing distant and divine sounds. The organ of hearing, the ear, grasps sound in space. This is the conquest of air.",
...
"Then consciousness is drawn strongly towards the seer or the soul due to the gravitational force of its exalted intelligence.",
...
"The yogi who has no interest even in this highest state of evolution, and maintains supreme attentive, discriminative awareness, attains dharma-meghah samadhi: he contemplates the fragrance of virtue and justice.",
...
"When dharmameghah samadhi is attained, qualities of nature (gunas) come to rest. Having fulfilled their purpose, their sequence of successive mutations is at an end.",
"As the mutations of the gunas cease to function, time, the uninterrupted movement of moments, stops. This deconstruction of the flow of tie is comprehensible only at this final stage of emancipation.",
...
"Dreamless sleep (nidra) is the subtle thought pattern which has as its object an inertia, blankness, absence, or negation of the other thought patterns (vrittis).",
...
"Because the methods may be applied in slow, medium, or speedy ways, even among those who have such commitment and conviction, there are differences in the rate of progress, resulting in nine grades of practice.",
...
"To prevent or deal with these nine obstacle and their four consequences, the recommendation is to make the mind one-pointed, training it how to focus on a single principle or object.",
...
"The coloring (klesha) of I-ness or egoism (asmita), which arises from the ignorance, occurs due to the mistake of taking the intellect (buddhi, which knows, decides, judges, and discriminates) to itself be pure consciousness (purusha).",
...
"That three-part process of samyama is gradually applied to the finer planes, states, or stages of practice.",
"These three practices of concentration (dharana), meditation (dhyana), and samadhi are more intimate or internal than the previous five practices.",
"However, these three practices are external, and not intimate compared to nirbija samadhi, which is samadhi that has no object, nor even a seed object on which there is concentration.",
...
"These three transition processes also explain the three transformations of form, time, and characteristics, and how these relate to the material elements and senses.",
...
"By samyama on the three-fold changes in form, time, and characteristics, there comes knowledge of the past and future.",
"The name associated with an object, the object itself implied by that name, and the conceptual existence of the object, all three usually interpenetrate or commingle with one another. By samyama on the distinction between these three, the meaning of the sounds made by all beings becomes available.",
...
"But the underlying support of that knowledge (of the other persons mind, in 3.19) remains unperceived or out of reach.",
...
"In the same way as described in relation to sight (3.21), one is able to suspend the ability of the body to be heard, touched, tasted, or smelled.",
...
"By samyama on the five forms of the elements (bhutas), which are gross form, essence, subtleness, interconnectedness, and it's purpose, then mastery over those bhutas is attained.",
...
"The transition or transformation into another form or type of birth takes place through the filling in of their innate nature.",
"Incidental causes or actions do not lead to the emergence of attainments or realization, but rather, come by the removal of obstacles, much like the way a farmer removes a barrier (sluice gate), so as to naturally allow the irrigation of his field.",
...
"Of these mind fields, the one that is born from meditation is free from any latent impressions that could produce karma.",
...
"Since memory (smriti) and the deep habit patterns (samskaras) are the same in appearance, there is an unbroken continuity in the playing out of those traits, even though there might be a gap in location, time, or state of life.",
"There is no beginning to the process of these deep habit patterns (samskaras), due to the eternal nature of the will to live.",
...
"Past and future exist in the present reality, appearing to be different because of having different characteristics or forms.",
"Whether these ever-present characteristics or forms are manifest or subtle, they are composed of the primary elements called the three gunas.",
"The characteristics of an object appear as a single unit, as they manifested uniformly from the underlying elements.",
...
"However, the object itself does not depend on any one mind, for if it did, then what would happen to the object if it were not being experienced by that mind?",
"Objects are either known or not known according to the way in which the coloring of that object falls on the coloring of the mind observing it.",
...
"Also resulting from that dharma-meghah samadhi (4.29), the three primary elements or gunas (4.13-4.14) will have fulfilled their purpose, cease to transform into further transformations, and recede back into their essence.",
"The sequencing process of moments and impressions corresponds to the moments of time, and is apprehended at the end point of the sequence.",
...
"When, through knowledge of the Atman, one ceases to desire any manifestations of Nature, then that is the highest kind of non-attachment.",
...
"By making samyama on the transformation that sense-organs undergo when they contact objects, on the power of illumination of the sense-organs, on the ego-sense, on the gunas which constitute the organs, and on the experiences they provide for the individual, one gains mastery of the organs.",
...
"Thus one is able to distinguish between two exactly similar objects, which cannot be distinguished by their spaces, characteristic marks, or positions in space.",
...
"The same object is perceived in different ways by different minds. Therefore the mind must be other than object.",
"The object cannot be said to be dependent on the perception of a single mind. For, if this were the case, the object could be said to be non-existent when that single mind was not perceiving it.",
...
"By regular inquiry into the role of the senses we can reduce mental distortions.",
...
"When one reaches this state, nothing is beyond comprehension. The mind can follow and help understand the simple and the complex, the infinite and the infinitesimal, the perceptible and the imperceptible.",
"When the mind is free from distraction, it is possible for all the mental processes to be involved in the object of inquiry. As one remains in this state, gradually one becomes totally immersed in the object. The mind then, like a flawless diamond, reflects only the features of the object and nothing else.",
"Initially, because of our past experiences and ideas, our understanding of the object is distorted. Everything that has been heard, read, or felt may interfere with our perception.",
...
"His knowledge is no longer based on memory of inference. It is spontaneous, direct, and at both a level and an intensity that is beyond the ordinary.",
...
"The obstacles are misapprehensions, confused values, excessive attachments, unreasonable dislikes, and insecurity.",
...
"In addition one becomes able to reflect on the very deep nature of our individual selves, including the source of perception, without being distracted by the senses and with freedom from misapprehension accumulated from the past.",
...
"Compared to the first five components of Yoga [sutra 2.29] the next three [sutras 3.1, 2, 3] are more intricate.",
...
"Samyama on the changes that arise in an individual's mind and their consequences develops in one the ability to acutely observe the state of mind of others.",
...
"Samyama on Polaris gives knowledge about the relative movements of the stars.",
"Samyama on the navel gives knowledge about the different organs of the body and their dispositions.",
"Using the throat as a point of inquiry for samyama provides an understanding of thirst and hunger. This enables one to control their extreme symptoms.",
...
"By mastering the forces that transmit sensations from the body to the mind it is possible to master the external stimuli. For instance, one can tolerate water of any temperature or the effects of thorns or one can walk on unstable surfaces and even feel as light as a balloon.",
...
"Mastery over the senses is achieved through samyama on the ability of the senses to observe their respective objects, how such objects are understood, how the individual identifies with the object, how the object, the senses, the mind, and the Perceiver are interrelated, and what results from such perception.",
"Then the response of the senses will be as swift as that of the mind. They will perceive acutely and the individual will have the capacity to influence the characteristics of the elements.",
...
"The temptation to accept the respectful status as a consequence of acquiring knowledge through samyama should be restrained. Otherwise, one is led to the same unpleasant consequences that arise from all obstacles to Yoga.",
...
"Influence on another by one whose mind is in a state of dhyana can never increase anxiety or other obstacles. In fact, they are reduced.",
...
"Thus the mind serves a dual purpose. It serves the Perceiver by presenting the external to it. It also repects [sic] or presents the Perceiver to itself for its own enlightenment.",
...
"A sequence is the replacement of one characteristic by one that follows it. This is linked to moment. A replacement of characteristics is also the basis of moment.",
...
"Egoism (asmitā) is tantamount (iva) to the identification (ekātmatā) of the Cognizant or Knowing (dṛk) Power --śakteḥ or śaktyāḥ*--1 (śaktyoḥ) --i.e. Puruṣa or the Absolute Consciousness-- with the cognitive (darśana) power --śakteḥ or śaktyāḥ--2 (śaktyoḥ) --i.e. Buddhi or intellect-- * śaktyoḥ means really of the two powers (Genitive Dual of śakti --power--).||6||",
...
"The states of mutation (parvāṇi) of the Guṇa-s (or qualities of Pradhāna1) (guṇa) (are): diversified (viśeṣa), undiversified (aviśeṣa), indicator-only (liṅgamātra) and one which is with no indication or mark --aliṅga-- (aliṅgāni) -- 1 Pradhāna is synonymous with Prakṛti. ||19||",
...
"Note that saṁskārayoḥ literally means of both of latent impressions (i.e. of those of Vyutthāna --manifest state-- and Nirodha --arrested state of mind--). In turn, abhibhavaprādurbhāvau literally means the subjugation (abhibhava) and appearance (prādurbhāva). I had to adapt the translation so that the purport of the aphorism may be understood properly. Through the latent impression(s) (saṁskārāt) of that (arrested state of mind) (tasya), a continuous undisturbed state of mental tranquility (praśānta-vāhitā) (is brought about and kept)||10||",
...
"Note that sarvārthataikāgratayoḥ literally means of both attention to all objects (sarva-arthatā) and one-pointedness (ekāgratā). In turn, kṣayodayau literally means on the diminution (kṣaya) and emergence/development (udaya). I had to adapt the translation so that the purport of the aphorism may be understood properly. There (tatas) again (punar) --i.e. during Samādhi--, the past (śānta) modification --pratyaya-- (pratyayau) being the same (tulya) as the present --údita-- (uditau) one --i.e. pratyaya-- (pratyayau), (occurs) the mutation (pariṇāmaḥ) of the one-pointed state (ekāgratā) of the mind (cittasya)||12||",
"Note that śāntoditau literally means a past --pratyaya or mental modification-- (śānta) and a present one (udita). In turn, tulyapratyayau literally means two mental modifications or pratyaya-s (pratyayau) being the same (tulya). I had to adapt the translation so that the purport of the aphorism may be understood properly. By means of this --i.e. through the previous exposition about the three mutations mentioned in the 9th, 11th and 12th aphorisms-- (etena), the mutations (pariṇāmāḥ) of essential attribute (dharma), temporal character (lakṣana) (and) state as old and new (avasthā) in the gross elements (bhūta) and Indriya-s --i.e. Powers of perception and action-- (indriyeṣu) (are) explained in detail (vyākhyātāḥ)||13||",
...
"In other words, even though two things look alike because the difference is indiscernible via class or species, temporal character and position, the Yogī can perceive the difference through that knowledge obtained by practicing Saṁyama on moment and its sequence. Knowledge (jñānam) which arises (jam) from discernment or discrimination (viveka) is Tāraka or intuitive knowledge (tārakam). (It is) comprehensive of all (sarva) things (viṣayam) appearing (viṣayam) at all times (sarvathā) and (ca) has no sequence (akramam... iti) Note that iti stands for inverted commas. ||54||",
"When there is equality (sāmye) of purity (śuddhi) between Buddhisattva --i.e. sattvic Buddhi-- (sattva) (and) Puruṣa (puruṣayoḥ), the state of complete Emancipation (kaivalyam iti) (dawns).  Note that iti now indicates the end of the section.  ||55||",
],[
...
"1 In other words, the mould of the new species into which one wants to be transformed fills in (or permeate) the essential nature of the new body and organs and shapes them according to the respective parameters. It is as if one were to exert pressure on a pile of wet sand with a recipient. The wet sand will assume the form of that recipient, no doubt. The process of transformation from one species into another proceeds in a similar way. Cause (nimittam) (does not set) the essential natures (prakṛtīnām) into motion (aprayojakam) but (tu) it breaks down (bhedaḥ) the barrier (or mound) (varaṇa). For that reason (tatas), it is like (vat) the farmer (kṣetrika) (who breaks down a barrier or mound so that the water may flow into his field)||3||",
...
"23. Karma is of two kinds -- soon to be fructified and late to be fructified. By making Samyama on these, or by the signs called Arishta,",
